  ...
  return (
    <header className="sticky top-0 z-50 w-full glass-panel border-b border-slate-800/60 bg-slate-950/80 backdrop-blur-xl h-12">
      <div className="w-full h-full flex items-center">
        {/* Logo Section - Precisely Aligned with Sidebar Icons (8px left padding + 48px centered icon) */}
        <div className="w-20 flex-shrink-0 flex items-center h-full border-r border-slate-800/40 px-2">
