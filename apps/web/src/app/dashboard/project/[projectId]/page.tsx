...
export default function ProjectDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 flex flex-col">
      {/* Dynamic Header */}
      <div className="border-b border-slate-900 bg-slate-950/50 backdrop-blur-xl sticky top-0 z-10 px-8 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <h1 className="text-xl font-bold text-white tracking-tight">Project Overview</h1>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <button 
              ...
              className="px-4 py-2 bg-teal-600 hover:bg-teal-500 rounded-lg text-sm font-bold text-white transition-all active:scale-95 flex items-center space-x-2"
            >
      ...
      {/* Main Content Area */}
      <main className="flex-1 p-8 md:p-12 max-w-7xl mx-auto w-full space-y-12 animate-in fade-in duration-500">
